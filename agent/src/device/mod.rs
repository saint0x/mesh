...
arch = "x86_64"
execution_providers = [
  {{ kind = "cpu", available = true, contract = {{ provider = "cpu", compatibility_class = "cpu_portable", optimization_profile = "cpu_serial", supports_decode_microbatch = true, supports_live_kv = true, kv_cache_layout = "host_paged", supports_checkpoint_handoff = true, supports_device_sampling = true, fast_path_eligible = true, memory_model = "system_ram", implementation_maturity = "verified_fast_path", verified_runtime = {{ fast_path_serving = true, decode_microbatch = true, live_kv = true, checkpoint_handoff = true, device_sampling = true }}, contract_hash = "{cpu_hash}" }} }},
  {{ kind = "metal", available = false, reason = "metal provider is only available on macOS", contract = {{ provider = "metal", compatibility_class = "metal_fast_path", optimization_profile = "metal_vectorized", supports_decode_microbatch = true, supports_live_kv = true, kv_cache_layout = "device_paged", supports_checkpoint_handoff = true, supports_device_sampling = true, fast_path_eligible = true, memory_model = "unified_memory", implementation_maturity = "verified_fast_path", verified_runtime = {{ fast_path_serving = true, decode_microbatch = true, live_kv = true, checkpoint_handoff = true, device_sampling = true }}, contract_hash = "{metal_hash}" }} }},
  {{ kind = "cuda", available = true, contract = {{ provider = "cuda", compatibility_class = "cuda_fast_path", optimization_profile = "cuda_fused", supports_decode_microbatch = true, supports_live_kv = true, kv_cache_layout = "device_paged", supports_checkpoint_handoff = true, supports_device_sampling = true, fast_path_eligible = true, memory_model = "discrete_vram", implementation_maturity = "verified_fast_path", verified_runtime = {{ fast_path_serving = true, decode_microbatch = true, live_kv = true, checkpoint_handoff = true, device_sampling = true }}, contract_hash = "{cuda_hash}" }} }},
]
default_execution_provider = "cuda"
provider_contracts = [
  {{ provider = "cpu", compatibility_class = "cpu_portable", optimization_profile = "cpu_serial", supports_decode_microbatch = true, supports_live_kv = true, kv_cache_layout = "host_paged", supports_checkpoint_handoff = true, supports_device_sampling = true, fast_path_eligible = true, memory_model = "system_ram", implementation_maturity = "verified_fast_path", verified_runtime = {{ fast_path_serving = true, decode_microbatch = true, live_kv = true, checkpoint_handoff = true, device_sampling = true }}, contract_hash = "{cpu_hash}" }},
