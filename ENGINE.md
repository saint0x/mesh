...
- ✅ In `throughput_first`, prefer older equally scored fresh decode cohorts before lease-count noise
...
- ✅ In `throughput_first`, prefer less transfer-exposed equally dense owned decode cohorts before broader but more transfer-exposed owned cohorts
- ✅ In `throughput_first`, prefer older equally scored owned decode cohorts before lease-count noise
...
- ✅ In `fit_first`, prefer older equally scored fresh decode cohorts before lease-count noise
- ✅ In `fit_first`, prefer owned decode cohorts with less remaining capacity before broader owned cohorts
- ✅ In `fit_first`, prefer less transfer-exposed owned decode cohorts before readier but more transfer-exposed owned cohorts when fill ties
- ✅ In `fit_first`, prefer older equally scored owned decode cohorts before lease-count noise
...
- ✅ In `resilient_edge`, prefer older equally scored fresh decode cohorts before lease-count noise
...
- ✅ In `resilient_edge`, prefer older equally scored owned decode cohorts before lease-count noise
...
- ✅ Renew and release owned pooled decode cohorts at cohort scope instead of single-session scope
- ✅ Promote owned pooled decode cohorts to active at cohort scope when decode is acknowledged
- ✅ Refresh remaining pooled decode targets when a sibling session completes or fails
