    ...
    let workers: Vec<WorkerInfo> = topology
        ...
        .map(|w| WorkerInfo {
            ...
            shard: ShardInfo {
                ...
                column_start: w.shard.layer_range.0,
                column_end: w.shard.layer_range.1,
...
pub async fn get_handoff(
    ...
    Ok(Json(HandoffInfo {
        ...
        column_start: handoff.layer_range.0,
        column_end: handoff.layer_range.1,
    ...
    let handoff_infos: Vec<HandoffInfo> = handoffs
        ...
        .map(|h| {
            ...
            HandoffInfo {
                ...
                column_start: h.layer_range.0,
                column_end: h.layer_range.1,
                model_id: h.model_id,
