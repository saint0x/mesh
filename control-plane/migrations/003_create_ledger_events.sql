...
CREATE INDEX IF NOT EXISTS idx_ledger_network_time ON ledger_events(network_id, timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_ledger_device_time ON ledger_events(device_id, timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_ledger_job ON ledger_events(job_id);
